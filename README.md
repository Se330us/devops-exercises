...
<table>
  <tr>
    ...
    <td align="center"><a href="#network"><img src="images/network.png" width="75px;" height="75px;" alt="Сети"/><br /><b>Сети</b></a></td>
...
<details>
<summary>Для каждого из следующих параметров определяется, к какому уровню OSI он относится:</summary><br><b>
